# Generated by Django 4.2.1 on 2023-07-03 08:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_report_investigation_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='professor_evidence.activity_report_investigation', verbose_name='Investigation Activity')),
                ('activity_report_management_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='professor_evidence.activity_report_management', verbose_name='Management Activity')),
                ('activity_report_teaching_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='professor_evidence.activity_report_teaching', verbose_name='Teaching Activity')),
                ('activity_report_vinculation_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='professor_evidence.activity_report_vinculation', verbose_name='Vinculation Activity')),
